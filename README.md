...
The quickest way to deploy the bot is to use Heroku's one-click deploy button, which will provision a server for your bot. See the [Manual Deployment](https://github.com/morganatlooker/looker-slackbot/tree/patch-1#manual-deployment) section below for more information on the environment variables needed. Once you have deployed via Heroku, skip to the [Configuring Slash Commands](https://github.com/morganatlooker/looker-slackbot/tree/patch-1#configuring-slash-commands) section of this document.
